      ...
      <Container>
        <section className="mt-8 mb-6 flex flex-col items-center justify-between relative gap-3 sm:flex-row">
          <div className="w-full flex items-center gap-4 text-lg flex-col sm:flex-row justify-center sm:justify-normal">
            <Image src={userImg} alt="User" className="rounded-full w-56 h-56 object-cover"/>
            <h1 className="font-bold text-2xl">Usuário Teste</h1>
          </div>
        ...
        <section className="flex flex-wrap gap-5 md:flex-grow md:flex-row flex-col">
